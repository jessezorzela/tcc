...
<a class="btn text-white rounded-5" href="/tcc/vagas/adicionarvaga.php?id_recrutador=<?php echo $id_recrutador?>" style="background-color: #712cf9;">Criar Vaga</a>
  <div class="row">
<?php
    $pchave = "";
...
while ($row = mysqli_fetch_array($rs)) {
    ...
    <div class='col-md-9'>
        ...
        <a class='btn text-white rounded-5' href='/tcc/vagas/ver.php?id_profissional=$id_profissional' style='background-color: #712cf9;' target='_blank' rel='noopener noreferrer'>Ver Vaga</a>
        </div>
    </div>
    </div>
    </div>
