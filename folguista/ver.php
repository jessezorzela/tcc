...
<div class="card p-3 border rounded-3 shadow-lg">
    ...
    <img src="/tcc/folguista/gerafoto.php?id_profissional=<?php echo $id_profissional?>" class="img card-img-top" style="width:95px; height:95px">
    <h3>Dados Pessoais</h3>
    <p class="form-label"><b>ID: #</b><?php echo $id_profissional?></p>

    <label class="form-label"> <b>Nome: </b><?php echo $nome?></label>
    
     <p class="form-label"> <b>Curso:</b>
     <label name="idcurso">
