...
<body>
  ...
  <div class="col-md-8">
    <div class="card p-4 text-center text-bg-dark shadow-lg" style="margin-top: 150px;">
            <h2 class="display-4 fw-bold lh-1 mb-3">Login</h2>
            <form class="text" action="validalogin.php" method="post">
            ...
            <br>
            <a class="btn text-white rounded-5" href="/tcc/adm/cadastro.php" style="background-color: #712cf9; width:100%;">CADASTRE-SE</a>
          </div>
